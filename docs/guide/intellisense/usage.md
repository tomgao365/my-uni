# Wot UI IntelliSense
一个为 Wot UI 组件库提供智能提示的 VS Code 插件，由 Wot UI 团队维护。
...
#### 下载地址
- [vscode marketplace](https://marketplace.visualstudio.com/items?itemName=wot-ui.wot-ui-intellisense)
- [open-vsx](https://open-vsx.org/extension/wot-ui/wot-ui-intellisense)
