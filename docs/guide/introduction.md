...
My Uni 是专为 uni-app 开发的摸鱼插件库，包含路由、CI/CD 等插件，助你轻松工作，天天摸鱼！基于 uni-app 能力，对标 web 流行技术栈，提供近似的开发体验，支持 APP、H5、微信小程序 等多平台。
...
- 🔧 **CI/CD** - 基于 uni-app 能力，提供简单的 CI/CD 功能
...
- [wot-ui](https://wot-ui.cn/) - 感谢 wot-ui 团队为 uni-app 组件生态做出的贡献。
